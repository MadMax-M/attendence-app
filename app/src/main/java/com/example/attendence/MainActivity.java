                ...
                reference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if(snapshot.exists()){
                            ...
                            reference.child("courses").child("subject1").child("present").setValue("0");
                            reference.child("courses").child("subject1").child("absent").setValue("0");
                            reference.child("courses").child("subject2").child("present").setValue("0");
                            reference.child("courses").child("subject2").child("absent").setValue("0");
                            reference.child("courses").child("subject3").child("present").setValue("0");
                            reference.child("courses").child("subject3").child("absent").setValue("0");
                            reference.child("courses").child("subject4").child("present").setValue("0");
                            reference.child("courses").child("subject4").child("absent").setValue("0");
